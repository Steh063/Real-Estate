        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ 
            ...
            <p style={{ 
              ...
              Меня зовут Павел, я — эксперт по продажам с 10+ годами опыта. Я строю команды, закрываю крупные сделки и повышаю продажи на 30–50%. В недвижимости я добьюсь для вас таких же результатов. Мой подход — это системные решения и фокус на прибыль.
            </p>
          </div>
        </div>
      </section>
